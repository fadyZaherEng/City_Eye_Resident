...
class WallImagesScreen extends StatefulWidget {
  final ImagesScreen imagesScreen;

  const WallImagesScreen({
    Key? key,
    required this.imagesScreen,
  }) : super(key: key);

  @override
  State<WallImagesScreen> createState() => _WallImagesScreenState();
}

class _WallImagesScreenState extends State<WallImagesScreen> {
        ...
        children: [
          PageView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return isUrl(widget.imagesScreen.images[index].attachment) ? PhotoView(
