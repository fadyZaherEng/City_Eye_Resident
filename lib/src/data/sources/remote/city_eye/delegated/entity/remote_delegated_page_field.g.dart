...
part of 'remote_delegated_page_field.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RemoteDelegatedPageField _$RemoteDelegatedPageFieldFromJson(
        Map<String, dynamic> json) =>
    RemoteDelegatedPageField(
      id: json['id'] as int? ?? 0,
...
Map<String, dynamic> _$RemoteDelegatedPageFieldToJson(
        RemoteDelegatedPageField instance) =>
    <String, dynamic>{
      'id': instance.id,
